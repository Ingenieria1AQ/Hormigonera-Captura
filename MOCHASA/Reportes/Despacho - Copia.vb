...
Public Class Despacho___Copia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HORMIGONERA.Despacho - Copia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDespacho___Copia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Despacho___Copia = New Despacho___Copia()
        rpt.Site = Me.Site
        Return rpt
    End Function
