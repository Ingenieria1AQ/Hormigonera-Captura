...
Public Class Despacho_Formato
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HORMIGONERA.Despacho_Formato.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDespacho_Formato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Despacho_Formato = New Despacho_Formato()
        rpt.Site = Me.Site
        Return rpt
    End Function
