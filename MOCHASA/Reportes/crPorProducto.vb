...
Public Class crPorProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CM_Construcciones.crPorProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPorProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPorProducto = New crPorProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
