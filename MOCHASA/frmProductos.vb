...
Public Class frmProductos
    ...
    Private Sub cargarproductos()
        ...
        Try
            ...
            Dim cmdtxt As String = "SELECT * FROM Productos order by Id_producto"
    ...
    Private Sub Enviar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Enviar.Click
        Dim i, j As Integer
        SerialPort1.Open()
        SerialPort1.Write("10,4%y")
        SerialPort1.Write("16,4;1%y")
   ...
   End Sub
    ...
    Private Sub seleccionar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles seleccionar.Click
        frmReportes.txtproducto.Text = DataGridView1.CurrentRow.Cells(0).Value
        frmReportes.txtNomProducto.Text = DataGridView1.CurrentRow.Cells(1).Value
        Me.Close()
    End Sub
        ...
        Do While Not sFileReader.Peek = -1
            ...
            Try
                ...
                If datos.Length >= 2 Then
                    If datos(0).Length <> 0 And datos(1).Length <> 0 And datos(2).Length <> 0 Then
                        cmd = New OleDbCommand("insert into Productos values('" & datos(0) & "','" & datos(1) & "')", oOleDbConnection)
                        cmd.ExecuteNonQuery()
                    Else
    ...
    Private Sub Btt_EnviarZM_Click(sender As Object, e As EventArgs) Handles Btt_EnviarZM.Click
        ...
        Funciones.enviaDatosSocket("p" & vbCrLf, Txt_Estado)
        ...
        Funciones.enviarArchivo("Productos", Btt_EnviarZM, Txt_Estado)
    End Sub
End Class